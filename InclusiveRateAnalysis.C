...
void InclusiveRateAnalysis::GeneratePseudoData( Int_t _n_events, Int_t _n_events_per_lund_file, const char* _dir_for_lund_files )
{
  ...
  for( Int_t _ilf = 0 ; _ilf < _n_lund_files; _ilf++ ){ _out_lund_file[ _ilf ].open( Form( "%s/out_lund_files_n%d.dat", _dir_for_lund_files, _ilf ) ); }
...
void InclusiveRateAnalysis::BookHistos()
{
  ...
  hQ2vsW                    = new TH2D( "hQ2vsW"                   , "Q^{2} (GeV^{2}); W (GeV)",                                  histosNBins,      0.0,      5.0,  histosNBins,        0,       15.0                                 ) ;
  hQ2vsWGen                 = new TH2D( "hQ2vsWGen"                , "Q^{2} (GeV^{2}); W (GeV)",                                  histosNBins,      0.0,      5.0,  histosNBins,        0,       15.0                                 ) ;
